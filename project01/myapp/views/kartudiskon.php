                        ...
                        <form method="post">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="persen_diskon" class="form-control" required>
                                </div>
                ...
                <tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="persen_diskon">Persen Diskon</label>
                                            <input type="text" name="persen_diskon" class="form-control" value="<?= $item['persen_diskon'] ?>" required>
                                        </div>
                                            <input type="hidden" name="id" value="<?= $item['id'] ?>">
                    ...
                    if (isset($_POST['type'])) {
                        if ($_POST['type'] == "delete") {
                            $kartudiskon->delete($_POST['id']);
                            echo '<script>alert("hapus berhasil")</script><meta http-equiv="refresh" content="0; url=?url=kartudiskon">';
                            ...
                            echo '<script>alert("tambah berhasil")</script><meta http-equiv="refresh" content="0; url=?url=kartudiskon">';
                            ...
                            $kartudiskon->update($_POST['id'], $data);
                            echo '<script>alert("update berhasil")</script><meta http-equiv="refresh" content="0; url=?url=kartudiskon">';
                        }
                    }
                    ?>
                </tbody>

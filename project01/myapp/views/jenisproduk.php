                ...
                <tbody>
                    ...
                    if (isset($_POST['type'])) {
                        if ($_POST['type'] == "delete") {
                            $jenisproduk->delete($_POST['id']);
                            echo '<script>alert("hapus berhasil")</script><meta http-equiv="refresh" content="0; url=?url=jenisproduk">';
                            ...
                            echo '<script>alert("tambah berhasil")</script><meta http-equiv="refresh" content="0; url=?url=jenisproduk">';
                        } elseif ($_POST['type'] == "update") {
                            $data = [
                                'nama' => $_POST['nama'],
                                'deskripsi' => $_POST['deskripsi'],
                            ];
                            $jenisproduk->update($_POST['id'], $data);
                            echo '<script>alert("update berhasil")</script><meta http-equiv="refresh" content="0; url=?url=jenisproduk">';
                        }
                    }
                    ?>
                </tbody>
